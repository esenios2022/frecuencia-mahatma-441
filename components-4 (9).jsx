    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{textAlign:"center", marginBottom:"28px"}}>
          ...
          <div style={{marginTop:"12px",fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:"21px",fontWeight:500,color:"#fff",letterSpacing:"0.04em"}}>
            Frecuencia Mahatma
          </div>
          <div style={{fontFamily:"'Cormorant Garamond',Georgia,serif",fontSize:"19px",color:"#D4AF37",letterSpacing:"0.25em"}}>
            · 441 ·
          </div>
        </div>
        ...
        <form onSubmit={intentar}>
          ...
          <input
            ref={inputRef} type="password" value={codigo} autoComplete="off"
      ...
      {/* Sección contacto — para quien no tiene código */}
      <div style={{
        position:"relative", zIndex:1,
        marginTop:"24px", maxWidth:"400px", width:"100%",
        ...
        <p style={{color:"rgba(255,255,255,0.5)",fontSize:"13px",marginBottom:"14px"}}>
          ¿Querés acceder a la plataforma? Contactanos
        </p>
        <div style={{display:"flex",gap:"10px",justifyContent:"center",flexWrap:"wrap"}}>
          <a href="mailto:esenios2022@gmail.com" style={{
            display:"inline-flex", alignItems:"center", gap:"7px",
            padding:"9px 16px", background:"rgba(47,165,115,0.12)",
            border:"1px solid rgba(47,165,115,0.35)", borderRadius:"8px",
            color:"#2FA573", fontSize:"12px", fontWeight:600,
            textDecoration:"none", letterSpacing:"0.05em"
          }}>✉ esenios2022@gmail.com</a>
          <a href="https://wa.me/59893422022?text=Hola%2C%20quiero%20acceder%20a%20Frecuencia%20Mahatma%20441" target="_blank" rel="noopener noreferrer" style={{
            display:"inline-flex", alignItems:"center", gap:"7px",
            padding:"9px 16px", background:"rgba(47,165,115,0.12)",
            border:"1px solid rgba(47,165,115,0.3)", borderRadius:"8px",
            color:"#2FA573", fontSize:"12px", fontWeight:600,
            textDecoration:"none", letterSpacing:"0.05em"
          }}>💬 WhatsApp</a>
        </div>
...
const TWEAK_DEFAULTS = /*EDITMODE-BEGIN*/{
  ...
  "displayFont": "serif", "useLiveAI": false,
  "geminiKey": "AIzaSyDzam7ZWIDEinZjRLpNPzkfI9zd20fJ28A"
} /*EDITMODE-END*/;

const BG_OPTIONS = {
  wide:{src:"assets/bg-wide.png",label:"Mundo Esmeralda"},
  wide2:{src:"assets/bg-wide-2.png",label:"Pentagrama"},
...
function App({ isAdmin }) {
  ...
  const searchInputRef = useRA(null);
  ...
  function focusSearch(){setCurrentNav("Agente IA");smoothScrollTo(document.getElementById("agente-ia"),80);setTimeout(()=>searchInputRef.current?.focus(),400);}
  ...
  return (
    <div className="fm-app">
      ...
      <Header currentNav={currentNav} onNav={n=>{setCurrentNav(n);if(n==="Aulas")scrollToAulas();if(n==="Agente IA")focusSearch();}} onSearchFocus={focusSearch} />
      <main className="fm-main">
        <Hero onExplore={scrollToAulas} onSearch={focusSearch} />
        <BuscadorIA inputRef={searchInputRef} useLiveAI={tweaks.useLiveAI} geminiKey={tweaks.geminiKey} />
      ...
      {/* Botón admin — solo visible si sos admin */}
      {isAdmin && !adminOpen && (
        <button
          ...
          style={{
            ...
            background:"rgba(15,30,25,0.9)", border:"1px solid rgba(212,175,55,0.4)",
            borderRadius:"50%", width:44, height:44,
            display:"flex", alignItems:"center", justifyContent:"center",
            color:"#D4AF37", cursor:"pointer", fontSize:18,
      ...
      <TweaksPanel title="Tweaks">
        ...
        <TweakSection label="Agente IA">
          <TweakToggle label="Usar Gemini en vivo" value={tweaks.useLiveAI} onChange={v=>setTweak("useLiveAI",v)} />
          {tweaks.useLiveAI && <TweakText label="API Key" value={tweaks.geminiKey} onChange={v=>setTweak("geminiKey",v)} placeholder="AIza..." />}
        </TweakSection>
      </TweaksPanel>
    </div>
  );
...
function Manifiesto() {
  return (
    <section className="fm-manifesto">
      ...
      <p className="fm-manifesto-text"><strong>4</strong> — los cuatro elementos en equilibrio interno. <strong>4</strong> — las cuatro direcciones del campo áurico. <strong>1</strong> — la consciencia unificada que emerge cuando los anteriores se alinean.</p>
...
function Root() {
  ...
  if (!acceso) return <LoginGate onUnlock={admin => { setAcceso(true); setIsAdmin(admin); }} />;
