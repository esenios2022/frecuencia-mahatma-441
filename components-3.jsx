...
function fmDriveDownload(url) {
  const g = fmGoogleInfo(url);
  if (!g) return url;
  // confirm=t evita el popup de confirmación de descarga
  if (g.kind === "drive") return `https://drive.google.com/uc?export=download&confirm=1&id=${g.id}`;
    ...
    <footer className="fm-footer">
      ...
      <div className="fm-footer-inner">
        <div className="fm-footer-brand" style={{ gap: "20px" }}>
          ...
          <div className="fm-footer-title" style={{ fontFamily: "\"Cormorant Garamond\"" }}>Frecuencia Mahatma <span style={{ fontFamily: "\"Cormorant Garamond\"", fontSize: "25px", fontWeight: "500" }}>441</span></div>
